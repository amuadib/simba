...
new class extends Component {
    ...
    public string $mode = 'tambah'; // tambah | edit
    ...
    {
        $passwordRule = $this->mode === 'tambah'
            ? 'required|min:6|confirmed'
            : 'nullable|min:6|confirmed';

        $emailRule = $this->mode === 'tambah'
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <h6 class="fw-semibold mb-3">
                        @if($mode === 'edit')
                            <i class="bi bi-pencil-square me-1 text-warning"></i> Edit Pengguna
                        @else
                            <i class="bi bi-person-plus me-1 text-primary"></i> Tambah Pengguna
                        @endif
                    </h6>

                    <form wire:submit="{{ $mode === 'edit' ? 'update' : 'store' }}">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input wire:model="password" type="password"
                                ...
                                placeholder="{{ $mode === 'edit' ? 'Biarkan kosong jika tidak diubah' : 'Password baru' }}">
                            @error('password')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
