...
@section('content')
    ...
    <div class="rounded-3 p-3" style="border:2px dashed #0d6efd;">
        <h5>Data Anggota</h5>
        <form method="get" action="{{ route('pembelajaran.anggota.index', $pembelajaran->id) }}" class="row g-2 mb-3"
            id='filterForm'>
            @csrf
            <div class="col">
        ...
        <div class="row">
            ...
            <div class="col-md-2 d-flex flex-column justify-content-center gap-2">
                ...
                <button type="button" class="btn btn-outline-success" onclick="moveSelected('available','selected')">
                    ▶️
                </button>
                <button type="button" class="btn btn-outline-danger" onclick="moveSelected('selected','available')">
                    ◀️
                </button>
